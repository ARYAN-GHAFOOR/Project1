...
export default function Nav() {
  return (
    <header className=''>
    {/* Top bar */}
    <div className="bg-[#fafafa] flex justify-between items-center px-6 py-2 md:text-[14px] sm:text-[12px] text-[8px] font-medium text-gray-500">
      <Image src={"/logo1.png"} alt={''} width={30} height={30}/>

      <div>
  <p className="text-black text-md bg-white"></p>
</div>
